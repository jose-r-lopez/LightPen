...
public class PluginLoaderImpl implements PluginLoader {
    ...
    PluginLoaderImpl(ContextData ct) {
        ...
        try {
            for (String p : pluginNames) {
                ...
                if (newPlugin.newInstance() instanceof Plugin) {
                    Plugin pl_front = (Plugin) newPlugin.newInstance();
                    pl_front.setPluginPath(getPATH());
                    plugins.add(pl_front);
                }
            }
    ...
    private void setPluginPrefix(String prefix) {
        this.prefix = prefix;
    }
