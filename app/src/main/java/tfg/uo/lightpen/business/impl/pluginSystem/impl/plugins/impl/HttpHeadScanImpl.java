...
public class HttpHeadScanImpl implements IPluginImplementation {
    ...
    private void createReport() {
        for (Object o : policies.keySet()) {
            getErrors().add(policies.get(o));
        }
        createPolicyMap();
    }

    private void analyzeHeaders(HashMap<URL, Map<String, List<String>>> ans) {
