 ...
 */
public class plg_DirListing implements Plugin{

    //private static final String TAG = "DIRLISTING";
...
//        if (implementation == null) {
            try {
                Class<?> cl = Class.forName(pluginPath + ".impl.DirListingImpl");
                implementation = (IPluginImplementation) cl.newInstance();
            } catch (Exception e) {
                throw new RuntimeException("Unexpected failure on DirListing plugin:" + e.toString());
            }
  //      }
    ...
    public String showDescription() {
        ...
        return ctxD.getContext().getString(R.string.dl_description);
    }

    @Override
    public String showName() {
        return ctxD.getContext().getString(R.string.dl_name);
    }
