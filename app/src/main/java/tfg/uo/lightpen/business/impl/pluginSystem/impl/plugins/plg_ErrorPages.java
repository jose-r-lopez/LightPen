 ...
 */
public class plg_ErrorPages implements Plugin {

    // private static final String TAG = "ERRORPAGES";
  ...
  //      if (implementation == null) {
            try {
                Class<?> cl = Class.forName(pluginPath + ".impl.ErrorPagesImpl");
                implementation = (IPluginImplementation) cl.newInstance();
            } catch (Exception e) {
                throw new RuntimeException("Unexpected failure on Error pages plugin:" + e.toString());
            }
    //    }
    ...
    public String showDescription() {
        ...
        return ctxD.getContext().getString(R.string.ep_description);
    }

    @Override
    public String showName() {
        return ctxD.getContext().getString(R.string.ep_name);
    }

    @Override
    public Double showVersion() {
        return Double.parseDouble(ctxD.getContext().getString(R.string.ep_version));
    }
